...
## Repo structure
- `/docs/prompts` — system prompts (starting with the async auditor)
- `/docs/policies` — governance rules, approval gates, safety constraints
- `/docs/architecture` — system design, data flows, components
- `/schemas` — schemas for Truth Ledger, Drift Digest, Conflict Tickets, Work Register
- `/docs/parking_lot.md` — raw ideas and future topics
